...
schema_view = get_schema_view(
    openapi.Info(
        title="DMIRS-Backend API",
        default_version='v1',
        description="This is a documentation for all the endpoints available for DMIRS Backend.",
        license=openapi.License(name="MaxGEO"),
    ),
    public=True,
